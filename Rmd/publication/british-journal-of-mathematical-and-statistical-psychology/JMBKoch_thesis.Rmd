...
```{r, dev='cairo_pdf', include = T, warning = F, fig.cap='Mean Power and Type-I-Error Rates in Selecting non-zero Crossloadings. All hyperparameters of the RHSP are set to 1 in the results presented here.', fig.height=10, fig.width=8}
library(patchwork)
library(ggplot2)
