...
\caption{\label{fig:unnamed-chunk-6}Mean Power and Type-I-Error Rates in Selecting non-zero Crossloadings. All hyperparameters of the RHSP are set to 1 in the results presented here.}
\end{figure}
